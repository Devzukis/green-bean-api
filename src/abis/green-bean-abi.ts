export const greenBeanAbi = [
  ...
  { inputs: [], name: 'CannotBeClaimed', type: 'error' },
  { inputs: [], name: 'ChunkAlreadyProcessed', type: 'error' },
  { inputs: [], name: 'ClaimWindowNotOpen', type: 'error' },
  { inputs: [], name: 'InitialLockOn', type: 'error' },
  { inputs: [], name: 'MismatchedArrays', type: 'error' },
  { inputs: [], name: 'MismatchedTokenOwnerForClaim', type: 'error' },
